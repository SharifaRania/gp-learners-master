...
public class SRJava extends FitnessFunction {
    ...
    public void eval(Individual ind) {
        ...
        double[] predictedValues = new double[data.getNumberOfFitnessCases()]; //// SpRCo
        ...
        ///// SpRCo // Calculate Spearman's rank correlation
        double spearmanCorrelation = SpearmansRank.calculateSpearmanRankCorrelation(predictedValues, targetAux);
